      ...
      <main style={{maxWidth:'900px',margin:'0 auto',padding:'2rem 1.5rem 4rem'}}>
        ...
        <div style={{marginBottom:'2rem',padding:'1rem',background:'#faf7ff',borderRadius:'16px',border:'1.5px solid #e8d4ff'}}>
          ...
          <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(140px,1fr))',gap:'0.75rem'}}>
            <a href="https://www.forcise.jp/ic/kerastase" target="_blank" rel="noopener noreferrer sponsored" style={{display:'flex',alignItems:'center',gap:'8px',padding:'10px 12px',background:'white',borderRadius:'12px',textDecoration:'none',border:'1px solid #e8d4ff'}}><span style={{fontSize:'1.2rem'}}>💜</span><div><div style={{fontSize:'0.75rem',fontWeight:700,color:'#333'}}>ケラスターゼを今すぐ試す</div><div style={{fontSize:'0.65rem',color:'#9333ea'}}>美容室専売 → 公式サイトへ</div></div></a>
            <a href="https://kiwabi-japan.myshopify.com/pages/rv002-r-a8" target="_blank" rel="noopener noreferrer sponsored" style={{display:'flex',alignItems:'center',gap:'8px',padding:'10px 12px',background:'white',borderRadius:'12px',textDecoration:'none',border:'1px solid #fce4ec'}}><span style={{fontSize:'1.2rem'}}>🌸</span><div><div style={{fontSize:'0.75rem',fontWeight:700,color:'#333'}}>白髪染めを無料で試す</div><div style={{fontSize:'0.65rem',color:'#e91e8c'}}>口コミNo.1 → 公式サイトへ</div></div></a>
          </div>
        </div>
